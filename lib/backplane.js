...
module.exports = (function(){
    ...
    my.messageStore = {
        save: function(bus,channel,content){
            throw {
                name: "Echo: Option not set exception"
                ,message: "Backplane needs a messageStore with a save function."
            }
        }
        ...
        ,getChannelMessages: function(channel,callback){
            throw {
                name: "Echo: Option not set exception"
                ,message: "Backplane needs a messageStore with a getChannelMessages function"
            }
        }
    };
    ...
    my.handler = function(options){
        ...
        return function(req,res){
            ...
            switch(req.method){
                case "GET":
                    my.messageStore.getChannelMessages(channel,my.processGetChannel(res));
                    break;
                case "POST":
                    if(my.validate(req)){
