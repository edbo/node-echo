...
describe("utils", function(){
    ...
    describe("TBind trait", function(){
        ...
        describe("bind function", function(){
            beforeEach(function(){
                mockObject.caller(tbind.bind(tbind.callback));
            });

            it("should execute the function in the right context", function(){
                expect(result).toEqual('realName');
            });
        });
    });
});